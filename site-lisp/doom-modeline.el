...
(add-hook! 'go-mode-hook (setq +doom-modeline-env-command "go version  2>&1| awk '{print $3}' | cut -c3-"))
(add-hook! 'rust-mode-hook (setq +doom-modeline-env-command "rustc --version 2>&1 | awk '{print $2}'"))
